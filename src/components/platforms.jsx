  ...
  const candidates = [
    {
      ...
      goals: ['Expand financial aid opportunities', 'Implement campus-wide sustainability initiatives', 'Enhance mental health resources', 'Create more inclusive community spaces']
    },
    {
      id: 2,
      name: 'Joh Magok',
      ...
      goals: ['Fight for fair tuition rates', 'Expand digital learning resources', 'Implement cultural competency training', 'Enhance campus safety measures']
    },
    {
      id: 3,
      name: 'Taylor Singh',
      ...
      goals: ['Implement transparent financial reporting', 'Streamline administrative processes', 'Develop sustainable operation practices', 'Simplify funding for student organizations']
    },
    {
      id: 4,
      name: 'Riley Patel',
      ...
      goals: ['Optimize budget allocation', 'Develop comprehensive digital strategy', 'Establish clear performance metrics', 'Improve space utilization']
    },
    {
      id: 5,
      name: 'Casey Zhang',
      ...
      goals: ['Expand diverse event programming', 'Establish new campus traditions', 'Increase support for student organizations', 'Develop comprehensive wellness initiatives']
    },
    {
      id: 6,
      ...
      goals: ['Strengthen student voice in academic decisions', 'Expand access to learning resources', 'Increase undergraduate research opportunities', 'Enhance academic support services']
    },
  ];
                ...
                <>
                  <div className="candidates-summary">
                    {candidatesByPosition[position.id].map(candidate => (
                      ...
                      >
                        <div className="candidate-summary-image">
                      ...
                      >
                        <div className="candidate-header" onClick={(e) => toggleCandidate(candidate.id, e)}>
                          <div className="candidate-image-container">
                            <img src={candidate.image || "/placeholder.svg"} alt={candidate.name} className="candidate-image" />
                          </div>
